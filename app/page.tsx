        ...
        <div className="container px-6 mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
            <div className="max-w-2xl text-left md:text-center mx-auto">
              <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tighter">KONYA DIŞ CEPHE ÇÖZÜMLERİ</h2>
              <p className="text-lg text-silver-dark font-light">Evinizin her köşesi için Konya'da en uygun fiyatlı ve dayanıklı söve, mantolama ürünleri.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                ...
                desc: 'Isı tasarrufu sağlayan kaliteli çözümler.'
              },
              { 
                title: 'Dekoratif Söve', 
                img: 'https://images.unsplash.com/photo-1513519245088-0e12902e35ca?q=80&w=800',
                desc: 'Pencere ve kapı kenarı estetiği.'
              },
              { 
                title: '3D Duvar Paneli', 
                img: 'https://images.unsplash.com/photo-1620626397931-13137d6e8736?q=80&w=800',
                desc: 'İç ve dış mekan dekorasyonu.'
              }
            ].map((cat, i) => (
              <MotionDiv 
                key={i}
